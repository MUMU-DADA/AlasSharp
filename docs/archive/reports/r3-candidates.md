...
覆盖 1437 章 IR；有钩子的关卡 49 个；去重方法 14 个。
...
| 10 | `brute_clear_boss` | **2** | b2、d2 |
| 11 | `handle_in_stage` | **2** | c2、sp3 |
| 12 | `_campaign_ocr_result_process` | **1** | sp |
| 13 | `catch_camera_repositioning` | **1** | t4 |
| 14 | `execute_actions` | **1** | sp |
