...
| --- | --- | --- | --- | --- |
| `event_20240229_cn/sp` | 最大地图（20×10 = 200 格） | 2.9595 | 5.1991 | 1.8× |
| `event_20220915_cn/c2` | 中位规模（8×8 = 64 格） | 0.4500 | 0.7768 | 1.7× |

## 全库计划读取（1437 个导出 / 3019 个钩子 / 5694 步）

| 工具 | 做什么 | 墙钟（秒） |
| --- | --- | --- |
| `Alas.Server r5-plan` | 读全部导出 + 干跑全部钩子 + 统计 | 0.62 |
| `tools/diagnostics/r5_upstream_audit.py` | 审计上游 `campaign/` 源码（AST） | 5.67 |
