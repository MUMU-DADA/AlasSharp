...
| tier 分布 | A 1006 / B 326 / C 42 |
| battle_* 方法 | 3019（计划完整 2960 = 98.0%） |
| 引擎钩子（native_overrides） | 54 |
...
| 调用 | 总次数 | 用到的章节数 | A | B | C |
| --- | --- | --- | --- | --- | --- |
| `battle_default` | 1600 | 1309 | 1157 | 435 | 8 |
| `clear_siren` | 1371 | 1160 | 1079 | 292 | 0 |
| `clear_filter_enemy` | 1041 | 823 | 911 | 123 | 7 |
| `fleet_boss.clear_boss` | 715 | 712 | 517 | 193 | 5 |
| `clear_boss` | 575 | 575 | 489 | 86 | 0 |
| `fleet_boss.goto` | 7 | 5 | 4 | 3 | 0 |
...
| `clear_roadblocks` | 88 | 52 | 0 | 84 | 4 |  |
| `clear_all_mystery` | 57 | 33 | 0 | 55 | 2 |  |
| `clear_any_enemy` | 56 | 47 | 0 | 56 | 0 |  |
| `map.select` | 53 | 39 | 0 | 46 | 7 |  |
| `clear_chosen_enemy` | 49 | 12 | 0 | 47 | 2 |  |
| `clear_potential_roadblocks` | 45 | 39 | 0 | 43 | 2 |  |
| `fleet_2_push_forward` | 43 | 39 | 0 | 43 | 0 |  |
| `check_accessibility` | 39 | 39 | 0 | 37 | 2 |  |
| `fleet_2_protect` | 31 | 27 | 0 | 31 | 0 |  |
| `goto` | 24 | 10 | 0 | 24 | 0 |  |
| `pick_up_ammo` | 15 | 10 | 0 | 15 | 0 |  |
| `fleet_2_step_on` | 14 | 13 | 0 | 13 | 1 |  |
| `mob_move` | 13 | 7 | 0 | 10 | 3 |  |
...
`_goto` `clear_potential_boss` `execute_actions` `fleet_1.clear_chosen_enemy` `siren_list.pop`
